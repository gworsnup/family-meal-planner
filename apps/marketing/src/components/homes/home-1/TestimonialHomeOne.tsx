      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="azzle-iconbox-wrap2" data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="azzle-iconbox-wrap2" data-aos="fade-up" data-aos-delay="400">
              <div className="azzle-iconbox-rating">
                <img src="assets/images/home1/start.svg" alt="ratting" />
              </div>
              <div className="azzle-iconbox-content2">
          ...
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="azzle-iconbox-wrap2" data-aos="fade-up" data-aos-delay="600">
              <div className="azzle-iconbox-rating">
                <img src="assets/images/home1/start.svg" alt="ratting" />
              </div>
              <div className="azzle-iconbox-content2">
          ...
          <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="azzle-iconbox-wrap2" data-aos="fade-up" data-aos-delay="600">
              ...
              <div className="azzle-iconbox-author-wrap">
                <div className="azzle-iconbox-author-thumb">
                  <img src="assets/images/home1/author6.png" alt="thumb" />
                </div>
                <div className="azzle-iconbox-author-data">
                  <p>Henry Ochi</p>
